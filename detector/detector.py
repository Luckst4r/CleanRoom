...
SYSTEM_INSTRUCTION = (
    ...
    "People and pets are NOT untidiness: ignore any person or pet in the photo, and "
    "ignore anything a person is currently holding or actively using (a cup, phone, "
    "a blanket over their lap, etc.). Only flag items that are clearly left out or "
    "abandoned, not a person or what they are using right now.\n\n"
